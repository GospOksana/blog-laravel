    ...
    <header class="s-header">
        ...
        <div class="row s-header__navigation">
            ...
            <nav class="s-header__nav-wrap">
                ...
                <h3 class="s-header__nav-heading h6">Навігація</h3>

                <ul class="s-header__nav">
                    <li class="current"><a href="{{ route('home') }}" title="">Головна</a></li>
                    ...
                    @guest
                        <li>
                            <a href="{{ route('login') }}" title="">Увійти</a>
                        </li>
                    @endguest
                    @auth
                        <li>
                            <a href="{{ route('dashboard') }}" title="">Адмінпанель</a>
                        </li>
                    @endauth
